...
const initSelfForm = [{"name":"ADDRESS","type":"text","placeholder":"","value":"","required":"Y","minLength":"10","errors":""}];
...
const handleSubmit = (props) => {
    ...
    const address = selfForm[selfForm.findIndex( a => a.name === "ADDRESS")].value;
    const sql = `update deliveries set address='${address}', stock_upd_by='${accountInfo.email}' where order_id=${id}`;
    ...
    <Maincontainer className="container">
        ...
        <>
            <div className="d-flex justify-content-center mb-4">
                <div className="text-center text-white w-50 m-2 bg-danger"> ORDERID : {id}</div>
            </div>
            {selfForm.map ( (item,i) => 
