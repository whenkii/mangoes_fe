        ...
        <SigninContainer className="container">
            ...
            <div>
                ...
                <>
                    ...
                    {["admin", "superadmin"].includes(accountInfo.type) &&
                        <Link to="/admin" className="settings"><fiIcons.FiSettings className="settings-icon"/></Link>
                    }
                    </p>

                    {accountInfo.type === "personaladmin" &&
                        <Link to="/personaladmin" className="settings"><fiIcons.FiSettings className="settings-icon"/></Link>
                    }
